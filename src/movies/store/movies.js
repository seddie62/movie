import { MOVIES_FETCH, MOVIES_STATE, SET_MOVIES_META, SET_MOVIES_FILTERS, GET_MOVIE, MOVIE_STATE,
  GET_MOVIE_REVIEWS, GET_MOVIE_REVIEWS_STATE, API_KEY, GET_MOVIE_CAST, GET_MOVIE_CAST_STATE, GET_CURRENT_CAST, GET_CURRENT_CAST_STATE } from './store_constants'
...
const actions = {
  // fetch all movies
  [MOVIES_FETCH] ({ commit, state }, { cache = true, page = 1 } = {}) {
    commit(MOVIES_STATE, 'LOADING')
    var filters = state.movies.filters
    var url = ''
